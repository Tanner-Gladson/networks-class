/*  This file defines an ARP cache, which is made of two structures: an ARP
    ...
    --
    TODO: We need to handle the ARP requests generated by the IP-packet-sending code.
    ...
    TODO: We need to handle recieved ARP replies. "The ARP reply processing code 
    should move entries from the ARP request queue to the ARP cache"
